...
// Initialize brush for Scatterplot1 and points. We need these to be global. 
let brush1;
let myCircles1;
...
// Initialize brush for Scatterplot2 and points.
let brush2;
let myCircles2;
...
//Initialize bars. We need this to be global. 
let myBars;
...
d3.csv("data/iris.csv").then((data) => {
  ...
  // We need the scales for all of the following charts to be global
  let x1, y1, x2, y2, x3, y3;

  // We the need keys to be global
  ...
  function updateChart2(brushEvent) {
    ...
    // Start an empty set to store names of selected species
    ...
    myCircles2.classed("selected", function (d) {
      is_selected = isBrushed(extent, x2(d.Sepal_Width), y2(d.Petal_Width));
